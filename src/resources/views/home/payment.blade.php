                                            ...
                                            <td class="product-col">
                                                <div class="product">
                                                    ...
                                                    <h3 class="product-title">
                                                        ...
                                                        {{-- <input type="hidden" value="{{ $v_content->id}}"> --}}
                                            ...
                                            <td class="quantity-col">
                                                <div class="cart-product-quantity">
                                                    <form action="{{ URL::to('/update-cart-quantity') }}" method="GET">
                                                        ...
                                                        <input class="form-control" type="number" name="cart_quantity" value="{{ $v_content->qty }}" required autocomplete="off" style="padding: 2px 6px; font-size: 10px;" min="1" max="{{ $v_content->qty }}">
                                ...
                                <div id="accordion-payment">
                                    <div class="card">
                                        <div class="card-header" id="heading-3">
                                            <h2 class="card-title">
                                                <label>
                                                    <input name="payment_option" value="2" type="checkbox" style="display: none;">
                                                </label>
                                            </h2>
                                    ...
                                    <br>
                                    <button type="submit" value="Đặt hàng" name="send_order_place" class="btn btn-outline-primary-2 btn-order btn-block">
                                        <img src="{{ asset('UserLTE/assets/images/chatbot/money.png') }}" alt="" style="width: 45px; height: auto">&ensp; <strong> Thanh Toán Khi Nhận Hàng</strong>
                                    </button>
                                </div>
                            </form>
                            ...
                            <form action="{{ url('/vnpay_payment') }}" method="POST">
                                <div class="vnpay-btn">
                                    ...
                                    <button type="submit" name="redirect" class="btn btn-outline-primary-2 btn-order btn-block">
                                        <img src="{{ asset('UserLTE/assets/images/chatbot/vnpay.png') }}" alt="" style="width: 40px; height: auto">&ensp; <strong> Thanh Toán Với VNPAY</strong>
                                    </button>
                                </div>
                            </form>
                        </div>
