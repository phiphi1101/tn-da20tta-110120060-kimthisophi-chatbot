...
@section('content')
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ asset('UserLTE/assets/images/page-header-bg.jpg') }}')">
        <div class="container">
    ...
    <div class="page-content">
                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                <figure class="product-main-image">
                                    <img id="product-zoom" src="{{ $product->feature_image_path }}" data-zoom-image="{{ $product->feature_image_path }}" alt="product image">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    <a class="product-gallery-item active" href="#" data-image="{{ $product->feature_image_path }}" data-zoom-image="{{ $product->feature_image_path }}">
                                        <img src="{{ $product->feature_image_path }}" alt="product side">
                                    </a>

                                    @foreach ($product->images as $item)
                                    <a class="product-gallery-item" href="#" data-image="{{ $item->image_path }}" data-zoom-image="{{ $item->image_path }}">
                            ...
                            {{-- <div class="details-filter-row details-row-size">
                                    ...
                                    <div class="product-nav product-nav-dots">
                                        ...
                                        <a href="" style="background: #333333;"><span class="sr-only">Color
                                                name</span></a>
                                        <a href="" style="background: #e2f702;"><span class="sr-only">Color
                                                name</span></a>
                                        <a href="" style="background: #f5008b;"><span class="sr-only">Color
                                                name</span></a>
                                    </div><!-- End .product-nav --> --}}
                            ...
                            <div class="product-details-action">
                                <div class="details-action-col" style="display: flex; align-items: center;">
                                    <div class="product-details-quantity" style="margin-right: 10px;">
                                        <input type="number" name="qty" id="qty" class="form-control" value="1" min="1" step="1" data-decimals="0" required>
                                        <input name="productid_hidden" type="hidden" class="form-control" value="{{ $product->id }}">
        ...
        <div class="product-details-tab">
            <ul class="nav nav-pills justify-content-center" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="product-info-link" data-toggle="tab" href="#product-info-tab" role="tab" aria-controls="product-info-tab" aria-selected="false">Hướng Dẫn Kích Thước</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="product-review-link" data-toggle="tab" href="#product-review-tab" role="tab" aria-controls="product-review-tab" aria-selected="false">Đánh Giá Sản Phẩm (2)</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade" id="product-shipping-tab" role="tabpanel" aria-labelledby="product-shipping-link">
                    <div class="product-desc-content">
                        ...
                        <p>We deliver to over 100 countries around the world. For full details of the delivery
                            ...
                            within a month of receipt. For full details of how to make a return, please view our <a href="#">Returns information</a></p>
                    </div><!-- End .product-desc-content -->
                </div><!-- .End .tab-pane -->
            ...
            <div class="product product-7 text-center">
                <figure class="product-media">
                    <a href="{{ route('detail', $productsSellingItem->slug) }}">
                        <img src="{{ config('app.base_url') . $productsSellingItem->feature_image_path }}" alt="Product image" class="product-image" style="width: 300px; height: 350px;">
                    </a>
                ...
                <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="{{ route('detail', $productsSellingItem->slug) }}">{{ $productsSellingItem->name }}</a>
                    </h3>
                    <!-- End .product-title -->
                    <div class="product-price">
